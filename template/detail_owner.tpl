  ...
  <div class="w3-container">
    ...
    <form action="" method="POST">
        <table class="w3-table w3-striped">
            ...
            <tr><th>Price (per 1)</th>
            <td>${{row[2]}}</td>
            </tr>
            <tr><th>Number ({{row[3]}} left)</th>
            <td><input class="w3-input w3-border" type="number" name="number" min=0 value={{row[3]}} required></td>
            </tr>
            <tr><td>
                <button type="submit" formaction="/update" class="w3-button w3-block w3-green">Update</button>
              </td>
            <td>
